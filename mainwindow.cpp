            ...
            for(int i=0; i<ui->tableWidget->rowCount()-1;i++)
                    {
                      ...
                      /* rekord.append_attribute("tytul") =ui->tableWidget->item(i,1)->text().toStdString().c_str();
                       rekord.append_attribute("przelicznik_godzinowy") =ui->tableWidget->item(i,2)->text().toStdString().c_str();
                       rekord.append_attribute("godziny") =ui->tableWidget->item(i,3)->text().toStdString().c_str();
                       rekord.append_attribute("przelicznik_milazu_refundowanego") =ui->tableWidget->item(i,4)->text().toStdString().c_str();
                       rekord.append_attribute("milaz_refundowany") =ui->tableWidget->item(i,5)->text().toStdString().c_str();
                       rekord.append_attribute("przelicznik_milazu_niereundowanego") =ui->tableWidget->item(i,6)->text().toStdString().c_str();
                       rekord.append_attribute("milaz_nierefundowany") =ui->tableWidget->item(i,7)->text().toStdString().c_str();
                       rekord.append_attribute("przelicznik_czasu") =ui->tableWidget->item(i,8)->text().toStdString().c_str();
                       rekord.append_attribute("czas") =ui->tableWidget->item(i,9)->text().toStdString().c_str();
                       rekord.append_attribute("suma_czasu") =ui->tableWidget->item(i,10)->text().toStdString().c_str();
                       rekord.append_attribute("dochod") =ui->tableWidget->item(i,11)->text().toStdString().c_str();
                       rekord.append_attribute("przelicznik_taxu_dojazdowego") =ui->tableWidget->item(i,12)->text().toStdString().c_str();
                       rekord.append_attribute("tax_dojazdowy") =ui->tableWidget->item(i,13)->text().toStdString().c_str();
                       rekord.append_attribute("inne") =ui->tableWidget->item(i,14)->text().toStdString().c_str();
                       rekord.append_attribute("zysk") =ui->tableWidget->item(i,15)->text().toStdString().c_str();*/
